# ****************************************************************************************************
# Script Name    : TextSearch_CompareChecker.py
#
...
#
# Example Usage:
#   - Run the script: python TextSearch_CompareChecker.py
...
class CompareChecker(QWidget):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Text Search and PROC COMPARE Checker")
        ...
        self.header = QLabel("📘 Text Search and PROC COMPARE Checker")
